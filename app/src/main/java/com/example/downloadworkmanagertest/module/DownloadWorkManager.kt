...
import com.example.downloadworkmanagertest.module.retrofit.DownloadFileRepository
import com.example.downloadworkmanagertest.module.retrofit.DownloadFileRetrofit
...
class DownloadWorkManager(context: Context, workerParameters: WorkerParameters) :
    ...
    override fun doWork(): Result {
        ...
        downloadInfo =
            Util.deserializeFromJson(inputData.getString(DOWNLOAD_INFO)) ?: return Result.failure()
